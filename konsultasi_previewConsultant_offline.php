...
<body>
                ...
                <div class=" spesialis-chooser col-12 col-sm-7  px-5 mt-5 mb-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-9 preview-spesialis">
                            <img src="img/bgSpesialist2.png" alt="" class="img-fluid">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-justify">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pulvinar et integer puru
                                    pretium felis in. Id vitae, massa ipsum eu, non mollis gravida morbi morbi.
                                    Semnequesed lectus risus etiam sollicitudin natoque auctor.
                                </p>
                            </div>
                            <div class="row">
                            ...
                            <div class="row pt-5">
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold"
                                        href="dashboard/html/user-app-chat.html" role="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal"><i class="bi bi-chat-dots-fill fs-3"></i>
                                        Chats</a>
                                </div>
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold"
                                        href="dashboard/html/user-app-chat.html" role="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal"><i class="bi bi-telephone-fill fs-3"></i>
                                        Telpon</a>
                                </div>
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold"
                                        href="dashboard/html/user-app-chat.html" role="button" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal"><i class="bi bi-camera-video-fill fs-3"></i>
                                        Zoom</a>
                                </div>
                                <!-- tentang spesialist -->
                            </div>
    ...
    <?php include './layout/modal_apointment.php'; ?>
