        ...
        <div class="container">
            <div class="sec-title text-center mb-50">
                ...
                <div class="sec-title text-center mb-45">
                    <div class="rs-carousel owl-carousel wow" data-loop="true" data-items="3" data-margin="30"
                        data-autoplay="true" data-autoplay-timeout="500" data-smart-speed="2000" data-dots="false"
                        ...
                        <div class="single-blog style2 white-bg ">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    ...
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius"
                                            href="#konsultasi">Lebih Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="single-blog style2 white-bg">
                            ...
                            <div class="blog-details">
                                <div class="blog-desc">
                                    ...
                                    <div class="about-btn">
                                        <a style="width: -10px; left: 5px;" class="readon radius" id="konsultasi"
                                            href="#">Lebih Lanjut</a>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <div class="about-btn">
                    <a class="readon radius" href="konsultasi.php">Mulai Sekarang</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="artikel-<?= $idx++; ?>">
                <div class="card2">
                    ...
                    <article>
                        ...
                        <p style="text-align: left;"><?= substr($r['isi'],0, 180) ?> <a
                                href="detail_berita.php?id=<?= $r['id'] ?>">read more</a></p>
                        <ul class="blog-meta">
                            <li style="margin-right: 50px; color: #01a0f9; width:200px"><i
                                    class="fa fa-calendar-check-o" aria-hidden="true"></i>Nov 28, 2019 <i
                                    class="fa fa-user-o" aria-hidden="true"></i>Admin</li>
                ...
                <div style="padding-top: -70px;" class="col-lg-7 pl-30 md-pl-15">
                    <div class="contact-form pt-100 md-pt-50">
                        ...
                        <form id="contact-form" method="post"
                            action="https://demo.auburnforest.com/html/neuron/demo/mailer.php">
                            <div class="row">
