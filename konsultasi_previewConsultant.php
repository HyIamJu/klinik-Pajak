                ...
                <div class=" spesialis-chooser col-12 col-sm-7  px-5 mt-5 mb-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-9 preview-spesialis">
                            <img src="img/bgSpesialist.png" alt="" class="img-fluid mx-auto">
                            <div class="row pt-4 mb-3">
                                <div class="col-8">
                                    <h3 class="mb-0 fw-bold">Usman Akbar</h3>
                                    <p class="fs-4">PPh Pasal 21</p>
                                </div>
                            ...
                            <div class="row pt-5">
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold" href="dashboard/html/user-home.html"
                                        role="button" data-toggle="modal" data-target="#modalApointment"><i
                                ...
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold" href="dashboard/html/user-home.html"
                                        role="button" data-toggle="modal" data-target="#modalApointment"><i
                                            class="bi bi-telephone-fill fs-3"></i>
                                        Telpon</a>
                                </div>
                                <div class="col-3 col-lg-4 text-center">
                                    ...
                                    <a class="btn btn-primary btn-md px-4 fw-bold" href="dashboard/html/user-home.html"
                                        role="button" data-toggle="modal" data-target="#modalApointment"><i
                                            class="bi bi-camera-video-fill fs-3"></i>
                                        Zoom</a>
                                </div>
